...
<style>
  ...
  .mia-fab{position:fixed;bottom:22px;right:22px;z-index:80;display:flex;align-items:center;gap:10px;
    padding:12px 20px 12px 14px;border:1px solid rgba(21,22,26,.4);border-radius:999px;cursor:pointer;
    background:rgba(255,255,255,.72);color:var(--mi-ink);
    -webkit-backdrop-filter:blur(16px) saturate(150%);backdrop-filter:blur(16px) saturate(150%);
    box-shadow:0 14px 40px rgba(0,0,0,.45);
    transition:transform .35s cubic-bezier(.16,1,.3,1),border-color .35s,background .35s}
  .mia-fab:hover{transform:translateY(-3px);border-color:rgba(58,60,68,.75);background:rgba(255,255,255,.9)}
  .mia-fab svg{width:20px;height:20px;flex:none}
  .mia-fab span{font-size:13px;letter-spacing:.14em;text-transform:uppercase;color:#15161A;font-weight:600}
  /* ---- Panel ---- */
  ...
  .mia-msg--bot{align-self:flex-start;background:var(--mi-glass);color:var(--mi-ink);
    border:1px solid var(--mi-line);border-radius:4px 18px 18px 18px}
  .mia-msg--user{align-self:flex-end;background:linear-gradient(135deg,#15161A,#b3924f);color:#17120E;
    border-radius:18px 4px 18px 18px;font-weight:500}
  .mia-msg a{color:#15161A;text-decoration:underline;text-underline-offset:2px}
  .mia-msg--user a{color:#17120E}
  .mia-typing{display:flex;gap:5px;align-items:center;padding:14px 16px}
  .mia-typing i{width:6px;height:6px;border-radius:50%;background:rgba(58,60,68,.8);animation:miaBlink 1.2s infinite}
  ...
  .mia-foot{flex:none;display:flex;gap:10px;padding:12px 14px calc(12px + env(safe-area-inset-bottom));
    border-top:1px solid rgba(21,22,26,.2);background:rgba(255,255,255,.6)}
  ...
  #mia-panel .mia-input{flex:1;min-width:0;background:var(--mi-glass) !important;
    border:1px solid var(--mi-line) !important;border-radius:999px !important;
...
<div id="mia-root">
  <button class="mia-fab" id="mia-fab" type="button" aria-label="Abrir chat con Mia" aria-haspopup="dialog">
    <svg viewBox="0 0 24 24" fill="none" stroke="#15161A" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
